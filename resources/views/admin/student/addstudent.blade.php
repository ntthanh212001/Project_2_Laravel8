        ...
        <form action="{{ route('student.add') }}" method="post" id="myForm" name="myForm" >
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <label class="radio-inline col-lg-4"><input type="radio" name="gioitinh" value="1" checked> Nam </label>
                    <label class="radio-inline col-lg-4"><input type="radio" name="gioitinh" value="0"> Nữ</label>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        <label class="form-label">Ngày sinh <span style="color: red;font-size: 10px;font-style: italic;"
                                id="error_ngaysinh"></span> </label>
                        <input type="date" name="ngaysinh" value="2021-01-01" max="2050-01-01" class="form-control">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" readonly name="password"
                            value="$2a$12$h3vXzp8xpFhWWpDCFO/50.OBcnIceKmPpCZbAhp.ERXNy54lGNFIa">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    ...
                    <select class="form-control form-control-lg" name="lop_id">
                        @foreach ($data as $item)
                            <option id="nganh_id"  value="{{ $item->id }}">{{ $item->tenlop }}</option>
                        @endforeach
                    </select>
                </div>
                {{-- <div class="col-lg-6 col-md-6 col-sm-12">
