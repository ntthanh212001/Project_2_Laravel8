...
@section('content')
    ...
    <table id="sinhvienTable" class="table table-bordered">
        <thead>
    ...
    <script>
        ...
        $("#sinhvienForm").submit(function(e) {
            e.preventDefault();
            let masv = $("#masv").val();
            let hoten = $("#hoten").val();
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response) {
                        $("#sinhvienTable tbody").prepend('<tr><td>' + response.id + '</td><td>' +
                            response.hoten + '</td><td>' + response.email + '</td><td>' + response
                            .ngaysinh + '</td><td>' + response.gioitinh + '</td><td>' + response
                            .phone + '</td><td>' + response.status + '</td></tr>');
