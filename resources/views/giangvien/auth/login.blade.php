...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img src="https://cdn3.iconfinder.com/data/icons/education-flat-icon-1/130/135-512.png" id="icon" alt="User Icon" />
    </div>
    <br>
  ...
  @endif
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="{{route('giangvien.login')}}">Đăng nhập sinh viên</a>
    </div>
